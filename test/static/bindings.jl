...
# # Runtime patch for Julia 1.12 compatibility
# # Redefine ParseState to use IO instead of specific GenericIOBuffer type
# if isdefined(CSTParser, :ParseState)
#     try
#         # Create a new ParseState struct with the correct type
#         struct NewParseState
#             l::Tokenize.Lexers.Lexer{IO,Tokenize.Tokens.RawToken}
#             done::Bool
#             lt::Tokenize.Tokens.RawToken
#             t::Tokenize.Tokens.RawToken
#             nt::Tokenize.Tokens.RawToken
#             nnt::Tokenize.Tokens.RawToken
#             lws::Tokenize.Tokens.RawToken
#             ws::Tokenize.Tokens.RawToken
#             nws::Tokenize.Tokens.RawToken
#             nnws::Tokenize.Tokens.RawToken
#             closer::CSTParser.Closer
#             errored::Bool
#         end

#         # Replace the old ParseState with the new one
#         CSTParser.ParseState = NewParseState

#         # Also need to update the constructor
#         function CSTParser.ParseState(str::Union{IO,String})
#             lexer = Tokenize.tokenize(str, Tokenize.Tokens.RawToken)
#             ps = NewParseState(lexer, false, Tokenize.Tokens.RawToken(), Tokenize.Tokens.RawToken(), Tokenize.Tokens.RawToken(), Tokenize.Tokens.RawToken(), Tokenize.Tokens.RawToken(), Tokenize.Tokens.RawToken(), Tokenize.Tokens.RawToken(), Tokenize.Tokens.RawToken(), CSTParser.Closer(), false)
#             return CSTParser.next(CSTParser.next(ps))
#         end
#     catch e
#         @warn "Failed to patch ParseState: $e"
#     end
# end
